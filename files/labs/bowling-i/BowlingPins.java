 ...
 */
public class BowlingPins extends GCompound
{
  // The size of a pin
  ...
  /**
   * Draws a set of bowling pins on the canvas.
   */
  public BowlingPins()
  {
    /* These local variables represent the location where the first pin in each
     * row should be placed. they will be updated as each row is created. */
    double xPinStart = 0.0, yPinStart = 0.0;

    /* *** Complete the code to place the bowling pins. Be sure to call
     *** this.add() to add your pins to the GCompound object.*/
  }
