 ...
 * white, black, or red, representing a white, dark, or colored clothing item at
 * the top of the hamper. Below this rectangle is 3 rectangles that represent 3
 * tubs of laundry - Whites, Darks, and Colors with appropriate colors and
 * labels. The user is to look at the color of the "clothing item" in the hamper
 * and select the appropriate tub. If selected correctly, the hamper will
...
public class LaundrySorter extends GraphicsProgram {
  ...
  public void init() {
    ...
    // set the color of the hamper outline as black
